...
@DisplayName("ModelsCommonTest должен ")
class ModelsCommonTest {
    ...
    @DisplayName("что в проекте нету связи OneToOne")
    @ParameterizedTest
    ...
    @DisplayName("что все связи LAZY")
    @ParameterizedTest
    @MethodSource("getEntities")
    ...
    @DisplayName(" что двунаправленные связи должны быть настроены с помощью mappedBy")
    @ParameterizedTest
    @MethodSource("getEntities")
