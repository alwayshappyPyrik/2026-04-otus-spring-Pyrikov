...
class CommonHwTest {
    ...
    @Test
    @DisplayName("проверить, что аннотацию @PropertySource лучше вешать над конфигурацией")
    ...
    @Test
    @DisplayName("проверить, что все внедряется через конструктор")
